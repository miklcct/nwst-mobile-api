...
class VariantIdentifierTest extends TestCase {
    public function testParse() : void {
        $variant = VariantIdentifier::parse('NWFB***14-GRP-3***1***22***10410***I', '***');
    ...
    public function test__toString() : void {
        $variant = new VariantIdentifier('14', Rdv::parse('14-GRP-3'), 1, 22, 10410, 'I');
        self::assertSame($variant->toString('||'), $variant->__toString());
    }

    public function testToString() : void {
        $variant = new VariantIdentifier('NWFB', Rdv::parse('14-GRP-3'), 1, 22, 10410, 'I');
